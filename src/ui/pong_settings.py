class SettingsUI:
    ...
    def __init__(self, app, previous_page = None):
        ...
        self.__sections = {
            'appearance': self.appearance.render,
            'controls': self.controls.render,
            'sound': self.sound.render
        }
    ...
    def render(self) -> None:
        ...
        self.__sections[SettingsUI.starting_page]()
...
class AppearanceSettings:
    ...
    def render(self) -> None:
        SettingsUI.starting_page = 'appearance'
...
class ControlSettings:
    ...
    def render(self) -> None:
        SettingsUI.starting_page = 'controls'
...
class SoundSettings:
    ...
    def render(self) -> None:
        SettingsUI.starting_page = 'sound'
