...
class GameModesUI:
    ...
    def render(self) -> None:
        ...
        self.app_widget.create_canvas_image_popper(canvas=inner_canvas, widget_to_hover=pvp_card, widget_canvas=player_vs_player_canvas,x=475, y=110, image_path=r"assets\pvp_Gamemode_ArrowSelection.png", img_width=51, img_height=38, debug_show=False, page = self, text = 'PVP')
        self.app_widget.create_canvas_image_popper(canvas=inner_canvas, widget_to_hover=pva_card, widget_canvas=player_vs_ai_canvas,x=238, y=110, image_path=r"assets\pva_Gamemode_ArrowSelection.png", img_width=51, img_height=38, debug_show=False, page = self, text = 'PVA')
        self.app_widget.create_canvas_image_popper(canvas=inner_canvas, widget_to_hover=cm_card, widget_canvas=custom_mode_canvas,x=712, y=110, image_path=r"assets\cm_Gamemode_ArrowSelection.png", img_width=51, img_height=38, debug_show=False, page = self, text = 'CM')
    ...
    def handle_inputs(self, canvas, pva_card, pva_canvas, pvp_card, pvp_canvas, cm_card, cm_canvas) -> None:
        ...
        self.app_widget.create_canvas_keybind_sign(master_canvas=canvas, key_bind='D', x_coordinate=688, y_coordinate=519,image_path=r'assets\keyboard_bindings.png', img_width=22, img_height=22, text='Right Selection', gap=83, font=("SF Pixelate", 10))

        self.app_widget.create_canvas_keybind_sign(master_canvas=canvas, key_bind='A', x_coordinate=483, y_coordinate=519,image_path=r'assets\keyboard_bindings.png', img_width=22, img_height=22, text='Left Selection', gap=80, font=("SF Pixelate", 10))
